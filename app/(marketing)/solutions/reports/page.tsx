...
export const metadata = {
  title: "Property-level accessibility reports",
  description:
  ...
  return (
    <figure className="relative">
      ...
      <figcaption className="sr-only">
        A sample AccessCheck PDF report — the property-level record landlords,
        reviewers and tenants can refer to at the end of an assessment.
      </figcaption>
    </figure>
  );
}
...
export default function ReportsPage() {
  return (
    <SolutionPage
      ...
      body={[
        {
          heading: "Designed for decisions, not just generation",
          text: "Reports lead with the headline accessibility category and the highest-impact issues, then drill into the rooms, the photos and the measurements. There’s no padding — nothing in the report is there unless a landlord or reviewer would actually use it.",
        },
        {
          heading: "Evidence you can act on",
          text: "Every finding links back to the photo, plan region or listing line that produced it. If a colleague asks ‘why category C?’, the answer is in the report — visible, evidenced and consistent across homes.",
        },
        {
          heading: "Drops straight into existing workflows",
          text: "Reports export as a single accessible PDF. They’re sized for email, named consistently, and built to sit alongside allocations records, accessible housing registers, asset and adaptations files, OT case notes, home improvement agency records and DFG submissions where relevant.",
        },
      ]}
    />
  );
